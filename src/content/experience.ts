...
export const experience: ExperienceEntry[] = [
  ...
  },
  {
    ...
    outcomes: ["Improved page load time by 40%", "Reduced UI regressions by 25%"],
  ...
  },
  {
    ...
    period: "2021 to 2022",
    location: "Remote",
    stack: ["React", "Electron", "Redux Toolkit", "React Query"],
    outcomes: ["Improved engagement by 20%", "Reduced deployment time by 20%"],
